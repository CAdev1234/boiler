var main_class_nclass =function() {
    this.viewpagename = "";
    var _viewp = "";
    var tablename = "";
    var language = "";
    ...
    var showchild = function (pid, o) {
        if (ischoose == true) {
            $.get("/management/nclass/showchild?tn=" + tablename + "&pid=" + pid + "&lang=" + language + "&tableType=" + tableType + "&choo=1&r=" + Math.random(), function (r) {
                $(o).html(r);
                band_eval(o);
            });
        } else {
            $.get("/management/nclass/showchild?tn=" + tablename + "&pid=" + pid + "&lang=" + language + "&r=" + Math.random(), function (r) {
                $(o).html(r);
                band_eval(o);
            });
        }
    }
    var user_showchild = function (pid, o) {
        if (ischoose == true) {
            $.get("/management/nclass/user_showchild?tn=" + tablename + "&pid=" + pid + "&lang=" + language + "&tableType=" + tableType + "&choo=1&r=" + Math.random(), function (r) {
                $(o).html(r);
                user_band_eval(o);
            });
        } else {
            $.get("/management/nclass/user_showchild?tn=" + tablename + "&pid=" + pid + "&lang=" + language + "&r=" + Math.random(), function (r) {
                $(o).html(r);
                user_band_eval(o);
            });
        }
    ...
    var band_eval = function (o) {
        ...
        $(o).children("div.nclass").each(function () {
            ...
            if (ischoose) {
                ...
                //添加
                $(this).children("div.ctrlclass").children("button.addc").click(function () {
                    showdioag("/management/" + _viewp + "/addchild?pid=" + cid + "&lang=" + language + "&a=a");
                });
                //修改
                $(this).children("div.ctrlclass").children("button.setc").click(function () {
                    showdioag("/management/" + _viewp+"/addchild?cid=" + cid + "&a=e");
                });
                //上移
                $(this).children("div.ctrlclass").children("button.movet").click(function () {
                ...
                //下移
                $(this).children("div.ctrlclass").children("button.moved").click(function () {
                    $.ajax({
                        type: "POST",
                        url: "/management/nclass/Dosort",
                ...
                //删除
                $(this).children("div.ctrlclass").children("button.delc").click(function () {
    ...
    var user_band_eval = function (o) {
        ...
        $(o).children("div.nclass").each(function () {
            ...
            if (ischoose) {
                ...
                //添加
                $(this).children("div.ctrlclass").children("button.addc").click(function () {
                    showdioag("/management/" + _viewp + "/user_addchild?pid=" + cid + "&lang=" + language + "&a=a");
                });
                //修改
                $(this).children("div.ctrlclass").children("button.setc").click(function () {
                    showdioag("/management/" + _viewp + "/user_addchild?cid=" + cid + "&a=e");
                });
                //上移
                $(this).children("div.ctrlclass").children("button.movet").click(function () {
    ...
    this.user_showchoose = function (o) {
        ischoose = true;
        get_tabname();
        getLanguAge();
        user_showchild("0", o);
    ...
    this.user_updatehtml = function (pid) {
        user_showchild(pid, $("#p" + pid));
        deldioag();
    }
    this.add_one_class = function () {
        showdioag("/management/" + _viewp + "/addchild?pid=0&lang=" + language + "&a=a");
    }
    this.user_add_one_class = function () {
       user_showdioag("/management/" + _viewp + "/user_addchild?pid=0&lang=" + language + "&a=a");
    }
}

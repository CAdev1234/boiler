(function ($) {
    var INTEROP_PATH = {
        ...
        //处理文件上传的地址
        server: '/management/FileUpload/Upload',
        //获取已上传文件的块数量
        GetMaxChunk: '/management/FileUpload/GetMaxChunk',
        //进行文件合并的地址
        MergeFiles: "/management/FileUpload/MergeFiles"
    };
        ...
        function addFile(file) {
            ...
            if (file.getStatus() === 'invalid') {
                ...
                uploader.makeThumb(file, function (error, src) {
                    ...
                    if (error) {
                        $wrap.text('不能预览');
                        $wrap.empty().append($('<img src="/lib/webuploader/image.png">'));
